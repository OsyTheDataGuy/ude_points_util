...
def extract_fighter_details(df, fighter_name):
    ...
    fighter_stats = df.apply(lambda row: {
        ...
        'is_champion': row['is_champion_fighter_1'] if is_fighter_1[row.name] else row['is_champion_fighter_2'],
        ...
        'dynamic_head_strikes_acc': row['dynamic_head_strikes_accuracy_fighter_1'] if is_fighter_1[row.name] else row['dynamic_head_strikes_accuracy_fighter_2'],
        'dynamic_body_strikes_acc': row['dynamic_body_strikes_accuracy_fighter_1'] if is_fighter_1[row.name] else row['dynamic_body_strikes_accuracy_fighter_2'],
        'dynamic_leg_strikes_acc': row['dynamic_leg_strikes_accuracy_fighter_1'] if is_fighter_1[row.name] else row['dynamic_leg_strikes_accuracy_fighter_2'],
        ...
        'dynamic_head_strikes_def': row['dynamic_head_strikes_defence_fighter_1'] if is_fighter_1[row.name] else row['dynamic_head_strikes_defence_fighter_2'],
        'dynamic_body_strikes_def': row['dynamic_body_strikes_defence_fighter_1'] if is_fighter_1[row.name] else row['dynamic_body_strikes_defence_fighter_2'],
        'dynamic_leg_strikes_def': row['dynamic_leg_strikes_defence_fighter_1'] if is_fighter_1[row.name] else row['dynamic_leg_strikes_defence_fighter_2'],
...
def extract_opponent_details(df, fighter_name):
    ...
    opponent_stats = df.apply(lambda row: {
        ...
        'opponent_is_champion': row['opponent_is_champion_fighter_2'] if is_fighter_1[row.name] else row['is_champion_fighter_1'],
        ...
        'opponent_dynamic_head_strikes_acc': row['dynamic_head_strikes_accuracy_fighter_2'] if is_fighter_1[row.name] else row['dynamic_head_strikes_accuracy_fighter_1'],
        'opponent_dynamic_body_strikes_acc': row['dynamic_body_strikes_accuracy_fighter_2'] if is_fighter_1[row.name] else row['dynamic_body_strikes_accuracy_fighter_1'],
        'opponent_dynamic_leg_strikes_acc': row['dynamic_leg_strikes_accuracy_fighter_2'] if is_fighter_1[row.name] else row['dynamic_leg_strikes_accuracy_fighter_1'],
        ...
        'opponent_dynamic_head_strikes_def': row['dynamic_head_strikes_defence_fighter_2'] if is_fighter_1[row.name] else row['dynamic_head_strikes_defence_fighter_1'],
        'opponent_dynamic_body_strikes_def': row['dynamic_body_strikes_defence_fighter_2'] if is_fighter_1[row.name] else row['dynamic_body_strikes_defence_fighter_1'],
        'opponent_dynamic_leg_strikes_def': row['dynamic_leg_strikes_defence_fighter_2'] if is_fighter_1[row.name] else row['dynamic_leg_strikes_defence_fighter_1'],
